...
public class Document extends EntityNameBase<Document> {
    ...
    public static final EntityCollectionPropertyInfo<Document, java.util.List, com.archtea.gae.sample.server.AttachedObject> ATTACHMENTS =
        EntityPropertyInfoFactory.getCollectionPropertyInfo(Document.class, java.util.List.class, com.archtea.gae.sample.server.AttachedObject.class, "Attachments");
    ...
    private final EntityCollectionProperty<Document, java.util.List, com.archtea.gae.sample.server.AttachedObject> attachments;
    ...
    public java.util.List<com.archtea.gae.sample.server.AttachedObject> getAttachments() throws EntityNotFoundException {
    ...
    public Document setAttachments(final java.util.List<com.archtea.gae.sample.server.AttachedObject> value) throws EntityNotFoundException {
