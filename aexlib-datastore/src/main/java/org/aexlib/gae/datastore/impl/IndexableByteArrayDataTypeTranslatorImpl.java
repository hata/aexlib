...
public class IndexableByteArrayDataTypeTranslatorImpl implements
        DataTypeTranslator {

    private static final IndexableByteArrayDataTypeTranslatorImpl translator =
        new IndexableByteArrayDataTypeTranslatorImpl();
    ...
    public Object toStoreType(Object userData) {
        return userData != null ? new ShortBlob((byte[])userData) : null;
    }

    public Object toUserType(Object storedData) {
        return storedData != null ? ((ShortBlob)storedData).getBytes() : null;
    }
