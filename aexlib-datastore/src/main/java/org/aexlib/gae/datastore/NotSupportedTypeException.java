...
public class NotSupportedTypeException extends RuntimeException {
    private static final long serialVersionUID = -3213616686609039899L;
    ...
    public NotSupportedTypeException(Throwable t) {
        super(t);
    }
    
    public NotSupportedTypeException(String message, Throwable t) {
        super(message, t);
    }
}
